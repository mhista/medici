...
class TTextTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
      ...
      headlineMedium: const TextStyle().copyWith(
          fontSize: 13.0, fontWeight: FontWeight.bold, color: PColors.dark),
      headlineSmall: const TextStyle().copyWith(
          fontSize: 12.0, fontWeight: FontWeight.w600, color: PColors.dark),
      titleLarge: const TextStyle().copyWith(
          fontSize: 17.0, fontWeight: FontWeight.w900, color: PColors.dark),
  ...
  static TextTheme darkTextTheme = TextTheme(
      ...
      headlineMedium: const TextStyle().copyWith(
          fontSize: 13.0, fontWeight: FontWeight.bold, color: PColors.light),
      headlineSmall: const TextStyle().copyWith(
          fontSize: 12.0, fontWeight: FontWeight.w600, color: PColors.light),
      titleLarge: const TextStyle().copyWith(
          fontSize: 17.0, fontWeight: FontWeight.w900, color: PColors.light),
      titleMedium: const TextStyle().copyWith(
